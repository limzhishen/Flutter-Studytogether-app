...
class LearnerSettings extends StatefulWidget {
  ...
  LearnerSettings({Key? key, required this.user}) : super(key: key);

  @override
  State<LearnerSettings> createState() => _LeanerSettingsState();
}

class _LeanerSettingsState extends State<LearnerSettings> {
